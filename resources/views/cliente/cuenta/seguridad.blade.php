...
<head>
    ...
    <title>Seguridad | Coffee.Dat</title>
        ...
        <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-6">
            ...
            <aside class="w-full md:w-[300px] flex-shrink-0 bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col h-max md:sticky md:top-[240px]">
                ...
                <div class="p-4 flex flex-col gap-1">
                    ...
                    <a href="{{ route('cuenta.seguridad') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-green-50 text-green-700 font-bold transition">
            ...
            {{-- CONTENIDO PRINCIPAL --}}
            <div class="flex-1">
                <div class="bg-white rounded-2xl shadow-sm p-6 md:p-10 border border-gray-100 relative overflow-hidden">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-[13px] text-gray-500 mt-1 ml-11">Actualiza tu contraseña para mantener tu cuenta segura.</p>
                        </div>
                    </div>

                    {{-- Formulario --}}
                    <form action="{{ route('cuenta.seguridad.actualizar') }}" method="POST">
                        @csrf
                        <div class="max-w-md flex flex-col gap-6">
                            
                            {{-- Contraseña Actual --}}
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Contraseña Actual</label>
                                <input type="password" name="current_password" required
                                       class="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-green-500 focus:border-green-500 text-base transition-all font-medium bg-white">
                            ...
                            {{-- Nueva Contraseña --}}
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Nueva Contraseña</label>
                            ...
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Confirmar Contraseña</label>
