...
<body class="font-sans antialiased bg-gray-50">
    ...
    {{-- ==========================================
            CONTENIDO PRINCIPAL
    =========================================== --}}
    <main class="min-h-screen bg-gray-50 flex items-center justify-center" style="padding-top:200px; padding-bottom:40px;">
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-10 flex flex-col items-center max-w-[400px] w-full mx-4">
            
            <div class="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-6 relative">
                {{-- Icono de usuario --}}
                <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-green-600 absolute ml-[-10px]" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd" />
                </svg>
                {{-- Icono de candado --}}
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-green-600 absolute bottom-[22px] right-[20px] bg-green-100 rounded-full border-2 border-green-100 p-0.5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
                </svg>
            </div>
            
            <h2 class="text-2xl font-extrabold text-[#1e293b] mb-4 text-center">Inicia sesión primero</h2>
            
            <p class="text-gray-500 text-center text-[15px] leading-relaxed mb-8 px-2">
                Debes estar registrado para ver tu perfil y gestionar tus pedidos.
            </p>
            
            <button type="button" x-data @click="$dispatch('open-login')" class="w-full bg-[#16a34a] hover:bg-green-700 text-white font-bold py-3.5 px-4 rounded-2xl text-center transition shadow-md text-lg">
                Ir al Login
            </button>
