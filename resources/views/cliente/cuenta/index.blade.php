        ...
        <div class="max-w-7xl mx-auto px-4 flex flex-col md:flex-row gap-6">
            ...
            <aside class="w-full md:w-[300px] flex-shrink-0 bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col h-max md:sticky md:top-[240px]">
                ...
                <div class="p-4 flex flex-col gap-1">
                    <a href="{{ route('cuenta') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl bg-green-50 text-green-700 font-bold transition">
            ...
            <div class="flex-1" x-data="{ editing: false }">
                <div class="bg-white rounded-2xl shadow-sm p-6 md:p-10 border border-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        ...
                        <button type="button" @click="editing = !editing" class="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-bold rounded-lg transition">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                            <span x-text="editing ? 'Cancelar edición' : 'Editar perfil'"></span>
                        </button>
                    </div>
                    ...
                    <form action="{{ route('cuenta.actualizar') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <input type="text" name="name" value="{{ auth()->user()->name }}" 
                                       :class="editing ? 'bg-white border-gray-300 focus:ring-green-500 focus:border-green-500' : 'bg-gray-50 border-transparent text-gray-600'"
                                       :readonly="!editing"
                                       class="w-full px-4 py-3 rounded-xl border text-base transition-all font-medium">
                            </div>
                            ...
                            {{-- Número de Documento --}}
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Número de Documento</label>
                                <input type="text" name="documento" value="{{ auth()->user()->documento ?? '' }}" 
                            ...
                            {{-- Teléfono --}}
                            <div class="flex flex-col gap-2">
                                <label class="text-xs font-bold text-gray-400 uppercase tracking-wider">Teléfono</label>
                        ...
                        {{-- Botón Guardar (Solo visible si editando) --}}
                        <div class="mt-8 flex justify-end" x-show="editing" x-transition>
                            <button type="submit" class="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-8 rounded-xl transition shadow-lg flex items-center gap-2">
