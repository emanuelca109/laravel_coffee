                ...
                <div class="bg-white rounded-xl shadow-lg border border-gray-100 relative overflow-hidden">
                    ...
                    <div class="p-8 pt-10">
                        ...
                        <div class="flex items-start justify-between mb-6">
                            <div>
                                <h1 class="text-2xl font-extrabold text-[#0f172a]">Nueva Dirección</h1>
                                <p class="text-[13px] text-gray-500 mt-1">Completa los datos para agregar tu dirección</p>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-6 gap-x-4 gap-y-5">
                            ...
                            <div class="flex flex-col gap-1.5 md:col-span-6">
                                ...
                                <select name="nombre_direccion" required
                                    ...
                                    <option value="Casa" {{ old('nombre_direccion') == 'Casa' ? 'selected' : '' }}>Casa</option>
                                    <option value="Trabajo" {{ old('nombre_direccion') == 'Trabajo' ? 'selected' : '' }}>Trabajo</option>
                                    <option value="Otro" {{ old('nombre_direccion') == 'Otro' ? 'selected' : '' }}>Otro</option>
                                </select>
                            ...
                            <div class="flex flex-col gap-1.5 md:col-span-6 mt-1">
                                ...
                                <textarea name="referencias" rows="2" 
                                          ...
                                          class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-green-100 focus:border-green-500 text-sm transition-all font-medium placeholder-gray-400 resize-none">{{ old('referencias') }}</textarea>
