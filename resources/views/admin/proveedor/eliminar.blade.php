...
<div id="modalEliminarProveedor"
    ...
    <div class="relative z-10 bg-white rounded-3xl shadow-2xl w-full max-w-sm p-6 text-center transform transition-all scale-100">
        ...
        <p class="text-gray-500 text-sm mb-6">
            Estás a punto de eliminar el proveedor <br>
            <span id="delete_nombre_proveedor" class="font-bold text-gray-800 text-base"></span>.<br>
...
<script>
window.abrirModalEliminar = window.abrirModalEliminarProveedor = function(id, nombre)
{
    document.getElementById('delete_nombre_proveedor').textContent = '"' + nombre + '"';
...
window.cerrarModalEliminar = window.cerrarModalEliminarProveedor = function()
{
    const modal = document.getElementById('modalEliminarProveedor');
    const card = modal.querySelector('.bg-white');
